...
"""     
        ...
        self.discussionHistory["talk"].append(json.loads(talk_text)["議論"])
        return talk
...
"""     
        ...
        self.discussionHistory["vote"].append(json.loads(vote_text)["議論"])
...
"""     
        ...
        self.discussionHistory["divine"].append(json.loads(divine_text)["議論"])
